 ...
 * @2015-6-29下午3:42:21
 */
public class DeleteBindingBankEvent extends HttpGetEvent
{
	...
	public DeleteBindingBankEvent(int nEventCode)
	{
		super(nEventCode);
	}
	...
	{
		super.run(params);
		if (eventCode == EventCode.HTTP_GET_DELETE_BANDING_BANK && isOk && !isMethodNotAllowed())
		{
