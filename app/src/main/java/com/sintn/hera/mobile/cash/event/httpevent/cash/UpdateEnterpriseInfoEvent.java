 ...
 * @2015-6-29下午3:42:21
 */
public class UpdateEnterpriseInfoEvent extends HttpPostEvent
{
	...
	public UpdateEnterpriseInfoEvent(int nEventCode)
	{
		super(nEventCode);
	}
	...
	{
		super.run(params);
		if (eventCode == EventCode.HTTP_POST_UPDATE_ENTERPRISE_INFO && isOk && !isMethodNotAllowed())
		{
