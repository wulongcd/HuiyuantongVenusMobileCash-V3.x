 ...
 * @2015-2-11下午3:41:49
 */
public class ShowNormalChioceMessagWithCallbackDialog extends BaseTouchHiddenSoftInputDialog {

    private String msg;
    private int callBackEventCode;

    public ShowNormalChioceMessagWithCallbackDialog(Context context, String msg, int callBackEventCode) {
