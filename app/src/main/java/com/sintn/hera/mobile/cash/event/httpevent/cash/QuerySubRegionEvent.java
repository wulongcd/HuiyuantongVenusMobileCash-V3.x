 ...
 * @2015-6-29下午3:42:21
 */
public class QuerySubRegionEvent extends HttpPostEvent
{
	...
	public QuerySubRegionEvent(int nEventCode)
	{
		super(nEventCode);
	}
	...
	{
		super.run(params);
		if (eventCode == EventCode.HTTP_POST_QUERY_SUB_REGION_LIST && isOk && !isMethodNotAllowed())
		{
