 ...
 * @2015-6-29下午3:42:21
 */
public class UpdateShopCashierEvent extends HttpPostEvent
{
	...
	public UpdateShopCashierEvent(int nEventCode)
	{
		super(nEventCode);
	}
	...
	{
		super.run(params);
		if (eventCode == EventCode.HTTP_POST_UPDATE_SHOP_CASHIER && isOk && !isMethodNotAllowed())
		{
