 ...
 * @2015-6-29下午3:42:21
 */
public class AddShopCashierEvent extends HttpPostEvent
{
	...
	public AddShopCashierEvent(int nEventCode)
	{
		super(nEventCode);
	}
	...
	{
		super.run(params);
		if (eventCode == EventCode.HTTP_POST_ADD_SHOP_CASHIER && isOk && !isMethodNotAllowed())
		{
