 ...
 */
public class BindPhoneEvent extends HttpPostEvent
{
	...
	public BindPhoneEvent(int nEventCode)
	{
		super(nEventCode);
	}
	...
	{
		super.run(params);
		if (eventCode == EventCode.HTTP_POST_BINDPHONE && isOk && !isMethodNotAllowed())
		{
