 ...
 * @2015-6-29下午3:42:21
 */
public class ResetPasswordEvent extends HttpPostEvent
{
	...
	public ResetPasswordEvent(int nEventCode)
	{
		super(nEventCode);
	}
	...
	{
		super.run(params);
		if (eventCode == EventCode.HTTP_POST_RESETPASSWORD_EVENT && isOk && !isMethodNotAllowed())
		{
