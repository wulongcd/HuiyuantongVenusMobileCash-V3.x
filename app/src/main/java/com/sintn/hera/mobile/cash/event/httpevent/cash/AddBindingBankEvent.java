 ...
 * @2015-6-29下午3:42:21
 */
public class AddBindingBankEvent extends HttpPostEvent
{
	...
	public AddBindingBankEvent(int nEventCode)
	{
		super(nEventCode);
	}
	...
	{
		super.run(params);
		if (eventCode == EventCode.HTTP_POST_ADD_BINDING_BANK && isOk && !isMethodNotAllowed())
		{
