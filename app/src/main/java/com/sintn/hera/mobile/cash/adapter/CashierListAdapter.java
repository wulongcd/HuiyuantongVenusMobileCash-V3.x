...
public class CashierListAdapter<T> extends BaseRecyclerAdapter<ShopManagerAccountForCashierAppDown>
{
	...
	public CashierListAdapter(Context context, String shopName)
	{
